...
BASE_DIR="${HOME}/Documents/repos/dl_wm"
WORK_DIR="${BASE_DIR}/outputs/2026-08-18"

VIDEO_BASENAME="youtube__1R7f3cLeaKk_watermarked.mp4"
JSONL_BASENAME="clips_ballard.jsonl"
FONT_PATH="${BASE_DIR}/fonts/Inter-Bold.otf"
TITLE_IMAGE_PATH="${TITLE_IMAGE_PATH:-${WORK_DIR}/title_682beds.png}"

RUN_NAME="ballard_howler"
